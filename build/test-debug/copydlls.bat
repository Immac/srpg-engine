pushd ..\..\..\install\
copy srpg-engine\bin\*.dll ..\proyecto-de-graduacion\build\test-debug\ /y
copy srpg-s2dge-system\bin\*.dll ..\proyecto-de-graduacion\build\test-debug\ /y
copy lua53\bin\*.dll ..\proyecto-de-graduacion\build\test-debug\ /y
